...
int main() {
	...
	//strcpy(input1, "hello");   //(destination,source)
	
	strncpy(input1, input2, 4); //(destination,source ,n(first till number string will print))
	...
	*/
    ...
    // check string equal to each other or not if equal retune 0
